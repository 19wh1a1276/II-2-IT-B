...
public class  add_Complex_numbers{
	public static void main(String[] args){
		...
		System.out.print("Enter real part of Complex_1 : ") ;
		x = scan.nextInt() ;
		System.out.print("Enter imaginary part of Complex_1 : ") ;
		y = scan.nextInt() ;
		Complex C1 = new Complex(x, y) ;
        System.out.println("Complex number 1 : " + C1.real + " + i" + C1.imaginary) ;
        System.out.print("Enter real part of Complex_2 : ") ;
		x = scan.nextInt() ;
		System.out.print("Enter imaginary part of Complex_2 : ") ;
		y = scan.nextInt() ;
